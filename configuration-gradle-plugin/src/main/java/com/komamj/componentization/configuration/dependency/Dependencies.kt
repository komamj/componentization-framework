...
package com.komamj.componentization.configuration.dependency
...
object Dependencies {
    ...
    object Others {
        ...
        const val SQLCIPHER = "net.zetetic:android-database-sqlcipher:${Versions.Others.SQLCIPHER}"
    }
    ...
    object JunitTest {
        ...
        const val PAGING_COMMON =
            "androidx.paging:paging-common:${Versions.JunitTest.PAGING_COMMON}"
    }
